...
public class GraphPanel
{
    ...
    public GridPane getGraphPanel()
    {
        ...
        NumberAxis xAxis1 = new NumberAxis(-700, 700, 100);
        xAxis1.setLabel("X");

        NumberAxis yAxis1 = new NumberAxis(-700, 700, 100);
        yAxis1.setLabel("Y");

        NumberAxis xAxis2 = new NumberAxis(-700, 700, 100);
        xAxis1.setLabel("X");

        NumberAxis zAxis2 = new NumberAxis(-700, 700, 100);
        zAxis2.setLabel("Z");

        NumberAxis xAxis3 = new NumberAxis(-700, 700, 100);
        xAxis1.setLabel("X");

        NumberAxis zAxis3 = new NumberAxis(-700, 700, 100);
        zAxis2.setLabel("Z");
